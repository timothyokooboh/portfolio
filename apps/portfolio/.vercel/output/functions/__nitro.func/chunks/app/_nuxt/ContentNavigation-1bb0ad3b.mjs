import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-6fc7ecdb.mjs';
import { x as hash } from '../../nitro/vercel.mjs';
import { d as useRuntimeConfig, a as __nuxt_component_0$1 } from '../server.mjs';
import { defineComponent, toRefs, computed, useSlots, useSSRContext, h } from 'vue';
import { u as useContentPreview } from './preview-a43fc676.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-09ccfa9d.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-1bb0ad3b.mjs.map
