...
import { e as asyncDataDefaults, u as useNuxtApp, c as createError, d as useRuntimeConfig } from '../server.mjs';
import { y as withLeadingSlash, j as joinURL, q as withoutTrailingSlash, z as withBase, x as hash } from '../../nitro/vercel.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-a43fc676.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-09ccfa9d.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-6fc7ecdb.mjs.map
