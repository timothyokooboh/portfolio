...
import omit$1 from '@dword-design/functions/dist/omit.js';
...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "993312be-af76-4dce-a78b-ad2c42074cf1"
  }
};
...
const _inlineRuntimeConfig = {
  ...
  "emailPassword": "zdkg gwap pris jvvl",
  "mdc": {
    "highlight": {}
  },
  "content": {
...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"29-GD87J7J2NilpQ7xhMIWeI8wmXTo\"","mtime":"2024-01-17T16:31:55.291Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"2c-0/Bwi0C9L2xr0aO6m312nJPeC0U\"","mtime":"2024-01-17T16:31:55.291Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:portfolio.json"]: {
    import: () => import('../raw/portfolio.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"f9a-ewsKtkUKbx1HfltCciTZulDG7d8\"","mtime":"2024-01-17T16:31:55.291Z"}
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/timothyokooboh/Desktop/my-portfolio/apps/portfolio/.data/kv"}));
...
const _x5fZh2 = defineEventHandler(async event => {
  try {
...
const parseJSONQueryParams = (body) => {
  try {
    ...
    throw createError$2({ statusCode: 400, message: "Invalid _params query" });
  }
};
...
const _77PDSd = defineEventHandler$1(async (event) => {
...
const _iGblJK = defineEventHandler$1(async (event) => {
...
const _SbgrN4 = defineEventHandler$1(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_i3yi0D = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_i3yi0D, lazy: true, middleware: false, method: undefined },
  { route: '/mail/send', handler: _x5fZh2, lazy: false, middleware: false, method: "post" },
  { route: '/api/_content/query/:qid/**:params', handler: _77PDSd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _77PDSd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _77PDSd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1705509048346.json', handler: _iGblJK, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _SbgrN4, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _SbgrN4, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _SbgrN4, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_i3yi0D, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, pascalCase as A, kebabCase as B, destr as C, parse$1 as D, getRequestHeader as E, isEqual as F, setCookie as G, getCookie as H, deleteCookie as I, klona as J, defuFn as K, prefixStorage as L, createStorage as M, memoryDriver as N, vercel as O, send$1 as a, setResponseStatus as b, setResponseHeaders as c, useRuntimeConfig as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$2 as h, getRouteRules as i, joinURL as j, getResponseStatusText as k, defu as l, hasProtocol as m, parseQuery as n, createHooks as o, parseURL as p, withoutTrailingSlash as q, withQuery as r, setResponseHeader as s, isScriptProtocol as t, useNitroApp as u, sanitizeStatusCode$1 as v, withTrailingSlash as w, hash as x, withLeadingSlash as y, withBase as z };
