    ...
    >
      ...
      <div>
        ...
        >
          ...
          I'm open to remote opportunities in the US and Europe and I'm willing
          to relocate. Please do feel free to check out my online profiles below
          and get in touch using the form. One of my key strengths is my ability
          to establish a robust infrastructure for maintainable frontend
          codebases. I am well-versed in setting up essential tools like ESLint,
          Prettier, and TypeScript to enforce coding standards and maintain code
          quality. I also have experience in configuring testing infrastructures
          using Testing Library (Vue.js & React.js), Jest, and Playwright to
          ensure the reliability of the applications I work on. Additionally, I
          have set up efficient build processes using GitHub Actions,
          streamlining the deployment pipeline for projects I've been involved
          in.
        </div>
