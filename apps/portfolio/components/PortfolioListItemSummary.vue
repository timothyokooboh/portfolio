<template>
  <div class="md:flex md:gap-x-[69px]">
    ...
    <IntersectionObserver
      custom-class="slide-down"
      class="md:basis-1/2 opacity-0"
    >
      <div
        class="w-full py-[24px] border-y-[1px] border-secondary-grey-200 border-solid md:pb-[50px] md:pt-[32px] lg:flex lg:flex-col lg:items-center lg:justify-center"
      >
        <div>
          <h2
            class="text-h2 font-ibarra font-bold leading-h2 mb-[24px] md:mb-[39px]"
          >
            {{ title }}
          </h2>
          <div
